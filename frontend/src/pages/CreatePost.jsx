...
const CreatePost = () => {
  ...
  const [craetePostError,setCreatePostError]=useState(null);
  ...
  const handleSubmit = async(e) => {
    ...
    try {
      ...
      if(res.ok){
        toast({title:"Article create successfully!"})
  ...
  return (
    <div className="p-3 max-w-3xl mx-auto min-h-screen">
      ...
      <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
          ...
          >
            ...
            <SelectContent>
              <SelectGroup>
                ...
                <SelectItem value="sportsnews">Sprots News</SelectItem>
        ...
        {craetePostError && <p className="text-red-600 mt-5">{craetePostError}</p>}
      </form>
    </div>
  );
};
